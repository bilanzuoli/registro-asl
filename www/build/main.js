...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_md5__ = __webpack_require__(217);
...
var __metadata = (this && this.__metadata) || function (k, v) {
 ...
 // importo il pacchetto per l'hash
...
var AuthService = (function () {
    ...
    AuthService.prototype.login = function (credentials) {
        ...
        if (credentials.email === null || credentials.password === null) {
            ...
            return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"].create(function (observer) {
                ...
                _this.storage.get(credentials.email).then(function (password) {
                    if (__WEBPACK_IMPORTED_MODULE_3_md5__(credentials.password) == password) {
                        observer.next(true);
                    }
                    else {
                        observer.next(false);
    ...
    AuthService.prototype.register = function (credentials) {
        ...
        if (credentials.email === null || credentials.password === null) {
            ...
            return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"].create(function (observer) {
                _this.storage.set(credentials.email, __WEBPACK_IMPORTED_MODULE_3_md5__(credentials.password)).then(function (val) {
                    if (val) {
                        observer.next(true);
                    }
                    else {
...
AuthService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__ionic_storage__["b" /* Storage */]) === "function" && _a || Object])
], AuthService);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers_auth_service_auth_service__ = __webpack_require__(195);
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/home/jcm/IONIC/MyIonicProject/src/app/app.html"*/'<ion-menu [content]="content">\n\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Pages</ion-title> //menu a scorrimento\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n'/*ion-inline-end:"/home/jcm/IONIC/MyIonicProject/src/app/app.html"*/
    }),
